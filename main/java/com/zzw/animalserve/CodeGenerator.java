...
//        String outputDir = "C://Users/VULCAN/Desktop/new";
        // 表名, 注意大小写
        String[] tableNames = new String[]{"article_tag"};
        // 数据库地址
        String url = "jdbc:mysql://localhost:3306/animals?useUnicode=true&characterEncoding=utf8";
        // 用户名
        String userName = "root";
        // 密码
        String password = "123456";
        // 父包路径
        String parentPackage = "com.zzw.animalserve";
        // 需要去掉的表名前缀
